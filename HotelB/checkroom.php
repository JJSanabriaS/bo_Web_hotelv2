...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<div class="large-12 columns " >
		<p><b>Fechas Reservacion</b></p><hr class="line">
				...
				<div class="row">
					<div class="large-12 columns">
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey">Niños (< 12 años)
								</span>
							</div>
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey" style="font-size:13.2px;">Num de noches permanencia
								</span>
							</div>
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<br><button name="submit" href="#" class="button small fontslabo" style="background-color:#2ecc71; width:100%;" >Editar informac</button>
					</div>
				  </div>
				</form>
		</div>
		<div class="large-12 columns" id="roomselected" style="display:none;" >
				<hr>
<br><label for="submit-form" class="book button small fontslabo" style="background-color:#2ecc71; width:100%; height:45px; !important;">Continue a detalles reserva</label>
<!--button name="submit" href="#" class="button small fontslabo" style="background-color:#2ecc71; width:100%;" >Continue a detalles reserva</button-->
		...
		<div class="large-12 columns" >
			<?php
				...
				if(mysqli_num_rows($result) > 0){
					echo "<p><b>Escoja su habitación</b></p><hr class=\"line\">";
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p><span class=\"fontgrey\">Capacidad : </span> ".$sub_row2['occupancy']."<br>\n";
								print "						<span class=\"fontgrey\">Tamaño : </span> ".$sub_row2['size']."\n";
								print "						<br><span class=\"fontgrey\">Vista : </span> ".$sub_row2['view']."</p>\n";
								print "\n";
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Diaria: </span><span style=\"font-size:24px;\">".$sub_row2['rate']."</span><span class=\"fontgrey\"> COP/noche</span><br>\n";
				...
				echo "<p><b>No existe cuarto disponible</b></p><hr>";
				}
					print "<button type=\"submit\" id=\"submit-form\" class=\"hidden\" style=\"display:none\">Reservacion</button>\n";
							print "	</form>";
