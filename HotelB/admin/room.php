      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="../start.php"><i class="icon-share"></i> Reservas (cliente)</a></li>
          </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="roomdetail">
		  ...
		  <button type="button" class="btn" id="addroom" style="background-color: #4CAF50" disabled>Adicionar cuarto</button>
        </div>
