			 ...
			 <h4 class="sub-header">Dashboard</h4>
				<div class="row">
					...
					if(mysqli_num_rows($re) > 0)
					{
						...
						echo "                                    </h3>\n";
						echo "                                    <p>\n";
						echo "                                        Reservas en los ultimos 7 dias\n";
						echo "                                    </p>\n";
						echo "                                </div>\n";
						echo "                                <div class=\"icon\">\n";
					...
					if(mysqli_num_rows($re2) > 0)
					{
						...
						echo "                                    </h3>\n";
						echo "                                    <p>\n";
						echo "                                        Reservas con pagos pendientes\n";
						echo "                                    </p>\n";
						echo "                                </div>\n";
						echo "                                <div class=\"icon\">\n";
						echo "                                    <i class=\"ion ion-person-add\"></i>\n";
				...
				<div class="row">
						<div class="col-xs-6" >
						<h4 class="sub-header">Busqueda Reserva</h4>
						...
						<h4 class="sub-header">Busqueda</h4>
