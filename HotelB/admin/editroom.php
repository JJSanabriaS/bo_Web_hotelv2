      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li ><a href="dashboard.php"><i class="icon-gauge"></i> Resumen <span class="sr-only">(current)</span></a></li>

			<li class="active"><a href="room.php"><i class="icon-key"></i> Cuartos</a></li>
		...
		print "					  </div>\n";
		print "					   <div class=\"form-group\">\n";
		print "						<label for=\"occupancy\">Capacidad</label>\n";
		...
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"size\">Tamaño</label>\n";
		...
		print "					  </div>\n";
		print "					  <button type=\"submit\" class=\"btn btn-default\" style=\"background-color: #4CAF50\">Actulizar detalles</button>\n";
		print "					</form>";
