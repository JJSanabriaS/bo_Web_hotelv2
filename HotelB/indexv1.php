...
<body class="fontbody" style="background-image : url(img/background1.jpg); no-repeat center center fixed; background-size: cover;">
...
<div class="row">
	...
	<p><b>Fechas</b></p><hr class="line">
			...
			<div class="row">
					...
					<div class="large-6 columns"  style="max-width:80%;">
						<label class="fontcolor">Niños (< 12 años)
			  ...
			  <div class="row">
				<div class="large-12 columns" >
					<button name="submit" href="#" class="button small fontslabo" style="background-color:#2ecc71; width:100%;" >Verificar disponibilidad</button>
				</div>
			  </div>
			</form>
	</div>
	...
	function validateForm(form) {
		...
		var d = form.totalchildrens.value;
			...
			if(c == 0) 
			{
			 	if(d == 0) 
				{
				 alert("Por favor escoja un numero de huepedes");
				 return false;
				}
			}
			if(d == 0) 
