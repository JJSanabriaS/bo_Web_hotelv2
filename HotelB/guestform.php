...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<div class="large-12 columns " >
		<p><b>Detalles Reservacion</b></p><hr class="line">
				...
				<div class="row">
					<div class="large-12 columns">
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall">Adultos
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall">Niños (< 12 años)
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall" >Noches pernotada
								</span>
							</div>
						...
						<div class="row"><hr>
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgreysmall" >Room Seleccionado
								</span>
							</div>

							<div class="large-4 columns" style="max-width:100%;">
								<span class="fontgreysmall">Cantidad
								</span>
				...
				<div class="row">
						<div class="large-12 columns" style="max-width:100%;">
							<p class="fontgrey borderstyle" style="text-align:center;">Descuento<br>
							<span class="fontslabo " style="font-size:24px; text-align:center;">COP <?php echo $_SESSION['deposit'];?></span>
							<br><span class="fontgrey" style="text-align:center;">Total</span><br>
							<span class="fontslabo" style="font-size:24px; text-align:center;">COP <?php echo $_SESSION['total_amount'];?></span></p>
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<button name="submit" href="#" class="button small fontslabo" style="background-color:#2ecc71; width:100%;">Editar Reservacion</button>
					</div>
				  </div>
				</form>
		</div>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		...
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  <div class="row">
			...
			<div class="large-6 columns">
			  <label class="fontcolor">Apellido*
		  ...
		  <div class="row">
			...
			<div class="large-6 columns">
			  <label class="fontcolor">Num. Telefono*
		  ...
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Dirección 1*
			...
			<div class="large-6 columns">
			  <label class="fontcolor">Dirección 2
		  ...
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Cod. postal*
			...
			<div class="large-6 columns">
			  <label class="fontcolor">País*
				<select name="country" id="country" type="text" placeholder=""   required>
						...
						{
						echo "<option value=\"\" selected=\"true\">País</option>";
						}
		  ...
		  <div class="row">
			<div class="large-12 columns">
			  <label class="fontcolor">Requerimientos Especiales
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo" style="background-color:#2ecc71;" onclick="return confirm('Are you sure you want to continue?')" >Confirmar</button>
		  </div>
